  ...
  if (subscription.tier === 'free') {
    return (
      <div className="flex items-start gap-3 rounded-xl bg-gray-50/70 px-4 py-3 ring-1 ring-gray-200 dark:bg-white/[0.04] dark:ring-white/10">
        ...
        <Link
          href={manageHref}
          className="inline-flex h-8 shrink-0 items-center rounded-md bg-primary px-3 text-[12px] font-medium text-primary-foreground transition-colors hover:bg-primary/90"
        >
          {t('freeCta')}
        </Link>
      </div>
