...
// unmapped endpoints emit nothing (deny-default); the PIN lockout seam now
// routes through the same emitter. The interim sink is a console JSON line —
// these tests pin the line shape the future core sink replaces.
