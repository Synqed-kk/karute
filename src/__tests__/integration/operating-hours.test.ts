...
/** No store hours, no closed dates, no saved org weekday — the shape every
 *  pre-PKT-1c-C call had implicitly. Nothing here can close a day, so these
 *  cases keep testing exactly the window rule they always tested. */
const NO_STORE: BookingDayHours = {
  weeklyHours: null,
