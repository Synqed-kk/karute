 ...
 *
 * Mock 1: @/lib/staff — provides a fake getStaffList() containing
 * TEST_STAFF_PROFILE_ID. Save actions validate the supplied staffId against
 * this org roster (synqed-core sourced in production).
 *
 * ```typescript
 * jest.mock('@/lib/staff', () => ({
 *   getBusinessId: jest.fn(async () => '00000000-0000-0000-0000-000000000001'),
 *   getStaffList: jest.fn(async () => [
 *     { id: '28318e68-6b73-46ed-a1a2-c21299deee3f', full_name: 'Test Staff', has_pin: false, created_at: '' },
 *   ]),
 * }))
 * ```
 *
