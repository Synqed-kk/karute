  ...
  it('the sealed files import EXACTLY their inventory — any new import goes red', () => {
    ...
    const INVENTORY: Record<string, string[]> = {
      ...
      'src/app/[locale]/(business)/business/settings/page.tsx': [
        './SettingsScreen',
        // ⚖ A2 — カードの見た目's one real save, handed to the screen only while the door is ON.
        './save-card-color',
        './settings-props',
        './settings.css',
        '@/business/lib/admission',
      ...
      // ⚖ A2 (Liam 9/24) — the server entry: admission (the expected business) and the data seam, nothing else.
      'src/app/[locale]/(business)/business/settings/save-card-color.ts': ['@/business/lib/admission', '@/business/lib/data'],
