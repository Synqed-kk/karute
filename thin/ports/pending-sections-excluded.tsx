...
// this slice (design-parity packet 12 §S1/§B-3 S2, packet 17 §S3, §S4b: 同期
// — 店舗 moved OUT at S2, 監査ログ at packet 17 §S3, スタッフ at packet 12
// §B-3 S4b, all three tabs now live). SettingsShell.tsx imports all ten
// settings sections unconditionally — the pendingTabIds runtime intercept
// (renderSection) ensures this one never actually RENDERS in the thin
// shell, but Rollup still has to bundle whatever it statically imports if
