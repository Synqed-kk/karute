...
export function LoginScreen() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    const { error } = await getMobileAuth().auth.signInWithPassword({
    ...
    // Success: onAuthStateChange(SIGNED_IN) flips the session-store and the
    // AuthGate swaps this screen for the router — no navigation needed.
  }
