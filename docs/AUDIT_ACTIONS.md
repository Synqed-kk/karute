...
| `ai.reengagement_draft` | ai | live | `settings.auditLog.actions.ai.reengagement_draft` |
...
| `recording.capture_warned` | recording | live | `settings.auditLog.actions.recording.capture_warned` |
...
| `recording.transcribe_storm` | recording | live | `settings.auditLog.actions.recording.transcribe_storm` |
| `recording.unshare` | recording | live | `settings.auditLog.actions.recording.unshare` |
