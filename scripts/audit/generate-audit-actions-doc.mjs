...
const LITERAL_ONLY_CATEGORY = {
  ...
  // literal-only doors below.
  'booking.store_write_refused': 'booking',
  'karute.store_write_refused': 'karute',
  'recording.store_write_refused': 'recording',
  'settings.store_write_refused': 'settings',
